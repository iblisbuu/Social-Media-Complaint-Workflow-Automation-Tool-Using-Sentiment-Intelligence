...
class App:
    def __init__(self, master):
        ...
        btne = ttk.Button(master, text="Exit", width=16, command=_quit)
        ...
        btn_start = ttk.Button(bottom_frame, text="Run Classifier", width=16, command=lambda: classifier())
        btn_start.pack(side='left', padx=10)
        btn_exit = ttk.Button(bottom_frame, text="View Sentiment", width=16, command=lambda: window1())
        btn_exit.pack(side='left', padx=10)
        btn_exit = ttk.Button(bottom_frame, text="View Posts", width=16, command=lambda: openInstrucktion())
        btn_exit.pack(side='left', padx=10)
        ...
        def window1():
            ...
            btn_exit = ttk.Button(bottom_frame, text="Exit", width=7, command=_quit)
            btn_exit.pack(side='left', padx=10)
        ...
        def classifier():
            ...
            btn_end = ttk.Button(bottom_fram, text="Exit", width=40, command=_quit)
